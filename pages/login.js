...
export default class LogIN extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            flag: true,
            link: 'https://elsawy2002.000webhostapp.com/project/login.php',
            user_email: '',
            user_password: '',
            color_input: true,
            user_name: '',
    ...
    async set_save_id() {
     ...
     async set_login_flag()
     {
         await AsyncStorage.setItem('login_flag',JSON.stringify(this.state.login_flag))
     }


     async get_login_flag()
     {
       let data=await AsyncStorage.getItem('login_flag')
         if (data)
         {
